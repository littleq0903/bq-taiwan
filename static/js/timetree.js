...
var TimetreeView = {
  ...
  */
  ...
  adjustXScaleRange: function() {
    this.get('xScale').range([0, this.get('barsWidth')]);
  },

  adjustYScaleRange: function() {
...
TimetreeView.content = App.ApiData;
TimetreeView.element = 'svg';
TimetreeView.init();
TimetreeView.didInsertElement();
// TimetreeView.renderNodes();
